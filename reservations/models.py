...
# version: 0.0.7
# REFACTOR: Reverted GenericForeignKey fields in PaymentConfirmation to be non-nullable
#           to enforce data integrity after the schema migration.
...
class PaymentConfirmation(models.Model):
    # REVERT: Fields are now non-nullable to enforce data integrity.
    ...
    def __str__(self):
        if self.content_object:
            return f"تایید پرداخت برای {self.content_object}"
        return f"تایید پرداخت شماره {self.id}"
